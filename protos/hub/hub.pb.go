...
type Host struct {
	...
	CountryShourt        string    `protobuf:"bytes,28,opt,name=country_shourt,json=countryShourt,proto3" json:"country_shourt,omitempty" pg:"country_shourt"`
	XXX_NoUnkeyedLiteral struct{}  `json:"-" pg:"-"`
	XXX_unrecognized     []byte    `json:"-" pg:"-"`
	XXX_sizecache        int32     `json:"-" pg:"-"`
}
...
func (m *Host) GetCountryShourt() string {
	if m != nil {
		return m.CountryShourt
	}
	return ""
}
...
var fileDescriptor_c704b5990190a69f = []byte{
	...
	,
}
...
func (m *Host) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.CountryShourt) > 0 {
		i -= len(m.CountryShourt)
		copy(dAtA[i:], m.CountryShourt)
		i = encodeVarintHub(dAtA, i, uint64(len(m.CountryShourt)))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xe2
...
func (m *Host) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 28:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CountryShourt", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.CountryShourt = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipHub(dAtA[iNdEx:])
