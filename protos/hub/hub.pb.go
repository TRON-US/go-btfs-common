...
type Host struct {
	...
	StoragePriceAsk      int64     `protobuf:"varint,20,opt,name=storage_price_ask,json=storagePriceAsk,proto3" json:"storage_price_ask,omitempty" pg:"storage_price_ask"`
	StoragePriceEst      int64     `protobuf:"varint,21,opt,name=storage_price_est,json=storagePriceEst,proto3" json:"storage_price_est,omitempty" pg:"storage_price_est"`
	...
	BandwidthPriceAsk    int64     `protobuf:"varint,23,opt,name=bandwidth_price_ask,json=bandwidthPriceAsk,proto3" json:"bandwidth_price_ask,omitempty" pg:"bandwidth_price_ask"`
	BandwidthPriceEst    int64     `protobuf:"varint,24,opt,name=bandwidth_price_est,json=bandwidthPriceEst,proto3" json:"bandwidth_price_est,omitempty" pg:"bandwidth_price_est"`
...
func (m *Host) GetStoragePriceAsk() int64 {
	if m != nil {
		return m.StoragePriceAsk
	}
	return 0
...
func (m *Host) GetStoragePriceEst() int64 {
	if m != nil {
...
func (m *Host) GetBandwidthPriceAsk() int64 {
	if m != nil {
		return m.BandwidthPriceAsk
	}
	return 0
...
func (m *Host) GetBandwidthPriceEst() int64 {
	if m != nil {
...
var fileDescriptor_c704b5990190a69f = []byte{
	...
	0xae, 0x6d, 0x70, 0xa5, 0xa6, 0xca, 0x01, 0x69, 0xdf, 0xef, 0xfd, 0xde, 0xcf, 0xbf, 0x37, 0x7f,
	0xde, 0x00, 0x6b, 0x61, 0xc4, 0x04, 0xe3, 0x9b, 0xe3, 0x78, 0x28, 0xff, 0x7a, 0x2a, 0xc4, 0x4b,
	...
	,
}
	...
	for iNdEx < l {
		...
		case 20:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.StoragePriceAsk |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 21:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.StoragePriceEst |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		...
		case 23:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.BandwidthPriceAsk |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 24:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.BandwidthPriceEst |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
