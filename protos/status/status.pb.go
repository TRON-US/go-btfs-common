...
var fileDescriptor_e9255cc60c5ca429 = []byte{
	...
	,
}
...
type StatusServiceClient interface {
	...
	UpdateBtfsScan(ctx context.Context, in *SignedMetrics, opts ...grpc.CallOption) (*types.Empty, error)
...
func (c *statusServiceClient) UpdateBtfsScan(ctx context.Context, in *SignedMetrics, opts ...grpc.CallOption) (*types.Empty, error) {
	out := new(types.Empty)
	err := c.cc.Invoke(ctx, "/status.StatusService/UpdateBtfsScan", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type StatusServiceServer interface {
	...
	UpdateBtfsScan(context.Context, *SignedMetrics) (*types.Empty, error)
...
func (*UnimplementedStatusServiceServer) UpdateBtfsScan(ctx context.Context, req *SignedMetrics) (*types.Empty, error) {
...
func _StatusService_UpdateBtfsScan_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SignedMetrics)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StatusServiceServer).UpdateBtfsScan(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/status.StatusService/UpdateBtfsScan",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StatusServiceServer).UpdateBtfsScan(ctx, req.(*SignedMetrics))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _StatusService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _StatusService_UpdateBtfsScan_Handler,
		},
		{
