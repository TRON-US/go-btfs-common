...
type NodeHealth struct {
	...
	FailurePoint         string     `protobuf:"bytes,3,opt,name=failure_point,json=failurePoint,proto3" json:"failure_point,omitempty" pg:"failure_point"`
	TimeCreated          *time.Time `protobuf:"bytes,4,opt,name=time_created,json=timeCreated,proto3,stdtime" json:"time_created,omitempty" pg:"time_created"`
	XXX_NoUnkeyedLiteral struct{}   `json:"-" pg:"-"`
	XXX_unrecognized     []byte     `json:"-" pg:"-"`
	XXX_sizecache        int32      `json:"-" pg:"-"`
}
...
type NodeError struct {
	HVal                 string     `protobuf:"bytes,1,opt,name=h_val,json=hVal,proto3" json:"h_val,omitempty" pg:"h_val"`
	PeerId               string     `protobuf:"bytes,2,opt,name=peer_id,json=peerId,proto3" json:"peer_id,omitempty" pg:"peer_id"`
	ErrorStatus          string     `protobuf:"bytes,3,opt,name=error_status,json=errorStatus,proto3" json:"error_status,omitempty" pg:"error_status"`
	TimeCreated          *time.Time `protobuf:"bytes,4,opt,name=time_created,json=timeCreated,proto3,stdtime" json:"time_created,omitempty" pg:"time_created"`
	XXX_NoUnkeyedLiteral struct{}   `json:"-" pg:"-"`
	XXX_unrecognized     []byte     `json:"-" pg:"-"`
	XXX_sizecache        int32      `json:"-" pg:"-"`
...
var fileDescriptor_e9255cc60c5ca429 = []byte{
	...
	,
}
