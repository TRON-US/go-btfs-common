...
/**
 * repeated StakeLedger ledgers = 4;
...
proto.escrow.StakeResult.prototype.getLedgersList = function() {
  return /** @type{!Array<!proto.escrow.StakeLedger>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.escrow.StakeLedger, 4));
};
...
proto.escrow.StakeResult.prototype.addLedgers = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 4, opt_value, proto.escrow.StakeLedger, opt_index);
};
