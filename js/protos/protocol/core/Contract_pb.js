...
proto.protocol.CreateSmartContract.toObject = function(includeInstance, msg) {
  var f, obj = {
    ownerAddress: msg.getOwnerAddress_asB64(),
    newContract: (f = msg.getNewContract()) && protos_protocol_core_Tron_pb.SmartContract.toObject(includeInstance, f),
...
proto.protocol.CreateSmartContract.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      ...
      break;
    case 2:
      var value = new protos_protocol_core_Tron_pb.SmartContract;
      reader.readMessage(value,protos_protocol_core_Tron_pb.SmartContract.deserializeBinaryFromReader);
...
proto.protocol.CreateSmartContract.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      2,
      f,
      protos_protocol_core_Tron_pb.SmartContract.serializeBinaryToWriter
    );
  }
...
proto.protocol.CreateSmartContract.prototype.getNewContract = function() {
  return /** @type{?proto.protocol.SmartContract} */ (
    jspb.Message.getWrapperField(this, protos_protocol_core_Tron_pb.SmartContract, 2));
};
