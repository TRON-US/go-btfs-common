...
proto.status.NodeContractStatReq.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    github_com_tron$us_go$btfs$common_protos_hub_hub_pb.Candidate.toObject, includeInstance)
  };
...
proto.status.NodeContractStatReq.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new github_com_tron$us_go$btfs$common_protos_hub_hub_pb.Candidate;
      reader.readMessage(value,github_com_tron$us_go$btfs$common_protos_hub_hub_pb.Candidate.deserializeBinaryFromReader);
...
proto.status.NodeContractStatReq.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      1,
      f,
      github_com_tron$us_go$btfs$common_protos_hub_hub_pb.Candidate.serializeBinaryToWriter
    );
  }
};
...
/**
 * repeated hub.Candidate candidates = 1;
 * @return {!Array<!proto.hub.Candidate>}
 */
proto.status.NodeContractStatReq.prototype.getCandidatesList = function() {
  return /** @type{!Array<!proto.hub.Candidate>} */ (
    jspb.Message.getRepeatedWrapperField(this, github_com_tron$us_go$btfs$common_protos_hub_hub_pb.Candidate, 1));
};
...
*/
proto.status.NodeContractStatReq.prototype.setCandidatesList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 1, value);
};
 ...
 */
proto.status.NodeContractStatReq.prototype.addCandidates = function(opt_value, opt_index) {
 ...
 * @return {!proto.status.NodeContractStatReq} returns this
 */
proto.status.NodeContractStatReq.prototype.clearCandidatesList = function() {
