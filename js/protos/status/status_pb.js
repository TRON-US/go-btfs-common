...
goog.exportSymbol('proto.status.AirdropRewardHistoryResp', null, global);
 ...
 * @constructor
 */
proto.status.AirdropRewardHistoryResp = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.status.AirdropRewardHistoryResp, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.status.AirdropRewardHistoryResp.displayName = 'proto.status.AirdropRewardHistoryResp';
}
...
proto.status.AirdropRewardHistoryReq.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    github_com_tron$us_go$btfs$common_protos_node_node_pb.AirdropRewardHistoryTab.toObject, includeInstance)
  };
...
proto.status.AirdropRewardHistoryReq.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new github_com_tron$us_go$btfs$common_protos_node_node_pb.AirdropRewardHistoryTab;
      reader.readMessage(value,github_com_tron$us_go$btfs$common_protos_node_node_pb.AirdropRewardHistoryTab.deserializeBinaryFromReader);
...
proto.status.AirdropRewardHistoryReq.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      1,
      f,
      github_com_tron$us_go$btfs$common_protos_node_node_pb.AirdropRewardHistoryTab.serializeBinaryToWriter
    );
  }
};
...
/**
 * repeated node.AirdropRewardHistoryTab rewards = 1;
 * @return {!Array<!proto.node.AirdropRewardHistoryTab>}
 */
proto.status.AirdropRewardHistoryReq.prototype.getRewardsList = function() {
  return /** @type{!Array<!proto.node.AirdropRewardHistoryTab>} */ (
    jspb.Message.getRepeatedWrapperField(this, github_com_tron$us_go$btfs$common_protos_node_node_pb.AirdropRewardHistoryTab, 1));
};


/**
 * @param {!Array<!proto.node.AirdropRewardHistoryTab>} value
...
/**
 * @param {!proto.node.AirdropRewardHistoryTab=} opt_value
 * @param {number=} opt_index
...
proto.status.AirdropRewardHistoryReq.prototype.addRewards = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.node.AirdropRewardHistoryTab, opt_index);
};
 ...
 * @return {!Object}
 */
proto.status.AirdropRewardHistoryResp.prototype.toObject = function(opt_includeInstance) {
  return proto.status.AirdropRewardHistoryResp.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.status.AirdropRewardHistoryResp} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.status.AirdropRewardHistoryResp.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.status.AirdropRewardHistoryResp}
 */
proto.status.AirdropRewardHistoryResp.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.status.AirdropRewardHistoryResp;
  return proto.status.AirdropRewardHistoryResp.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.status.AirdropRewardHistoryResp} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.status.AirdropRewardHistoryResp}
 */
proto.status.AirdropRewardHistoryResp.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.status.AirdropRewardHistoryResp.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.status.AirdropRewardHistoryResp.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.status.AirdropRewardHistoryResp} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.status.AirdropRewardHistoryResp.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getCode();
  if (f !== 0) {
    writer.writeInt32(
 ...
 * @return {number}
 */
proto.status.AirdropRewardHistoryResp.prototype.getCode = function() {
...
/**
 * @param {number} value
 * @return {!proto.status.AirdropRewardHistoryResp} returns this
 */
proto.status.AirdropRewardHistoryResp.prototype.setCode = function(value) {
 ...
 * @return {string}
 */
proto.status.AirdropRewardHistoryResp.prototype.getMessage = function() {
 ...
 * @return {!proto.status.AirdropRewardHistoryResp} returns this
 */
proto.status.AirdropRewardHistoryResp.prototype.setMessage = function(value) {
 ...
 * @return {?proto.google.protobuf.Timestamp}
 */
proto.status.AirdropRewardHistoryResp.prototype.getResponseTime = function() {
  return /** @type{?proto.google.protobuf.Timestamp} */ (
 ...
 * @return {!proto.status.AirdropRewardHistoryResp} returns this
*/
proto.status.AirdropRewardHistoryResp.prototype.setResponseTime = function(value) {
 ...
 * @return {!proto.status.AirdropRewardHistoryResp} returns this
 */
proto.status.AirdropRewardHistoryResp.prototype.clearResponseTime = function() {
 ...
 * @return {boolean}
 */
proto.status.AirdropRewardHistoryResp.prototype.hasResponseTime = function() {
