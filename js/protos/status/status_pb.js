...
var github_com_tron$us_go$btfs$common_protos_hub_hub_pb = require('../../github.com/tron-us/go-btfs-common/protos/hub/hub_pb.js');
goog.object.extend(proto, github_com_tron$us_go$btfs$common_protos_hub_hub_pb);
...
goog.exportSymbol('proto.status.BtfsScanAggrResp', null, global);
 ...
 * @constructor
 */
proto.status.BtfsScanAggrResp = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.status.BtfsScanAggrResp, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.status.BtfsScanAggrResp.displayName = 'proto.status.BtfsScanAggrResp';
}
 ...
 * @return {!Object}
 */
proto.status.BtfsScanAggrResp.prototype.toObject = function(opt_includeInstance) {
  return proto.status.BtfsScanAggrResp.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.status.BtfsScanAggrResp} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.status.BtfsScanAggrResp.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.status.BtfsScanAggrResp}
 */
proto.status.BtfsScanAggrResp.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.status.BtfsScanAggrResp;
  return proto.status.BtfsScanAggrResp.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.status.BtfsScanAggrResp} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.status.BtfsScanAggrResp}
 */
proto.status.BtfsScanAggrResp.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.status.BtfsScanAggrResp.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.status.BtfsScanAggrResp.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.status.BtfsScanAggrResp} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.status.BtfsScanAggrResp.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getCode();
  if (f !== 0.0) {
    writer.writeEnum(
...
/**
 * optional hub.ResponseCode code = 1;
 * @return {!proto.hub.ResponseCode}
 */
proto.status.BtfsScanAggrResp.prototype.getCode = function() {
 ...
 * @return {!proto.status.BtfsScanAggrResp} returns this
 */
proto.status.BtfsScanAggrResp.prototype.setCode = function(value) {
 ...
 * @return {string}
 */
proto.status.BtfsScanAggrResp.prototype.getMessage = function() {
 ...
 * @return {!proto.status.BtfsScanAggrResp} returns this
 */
proto.status.BtfsScanAggrResp.prototype.setMessage = function(value) {
